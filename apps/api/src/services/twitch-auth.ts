...
export const TwitchAuth = {
  ...
  saveToken(tokenData: typeof AuthSchemas.tokenResponse.infer, userData: typeof AuthSchemas.twitchUser.infer) {
    ...
    db.run(
      ...
      [tokenData.access_token, tokenData.refresh_token, userData.id, userData.login, userData.display_name],
    )
  },
